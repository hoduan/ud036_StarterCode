...
moonlight = media.Movie("Moonlight",
						" Free Fire, A Ghost Story, How to Talk to Girls at Parties, It Comes at Night, Woodshock, Slice, Good Time",
						DIR + "/poster/" + "moonlight_poster.jpg",
						"https://www.youtube.com/watch?v=9NJj12tJzqc"
						)

the_jungle_book = media.Movie("The Junge Book",
...
inside_out = media.Movie("Inside Out", 
						"Growing up can be a bumpy road, and its no exception for Riley, who is uprooted from her Midwest life when her father starts a new job in San Francisco. Like all of us, Riley is guided by her emotions: Joy, Fear, Anger, Disgust and Sadness. The emotions live in Headquarters, the control center inside Riley’s mind, where they help advise her through everyday life. As Riley and her emotions struggle to adjust to a new life in San Francisco, turmoil ensues in Headquarters. Although Joy, Riley's main and most important emotion, tries to keep things positive, the emotions conflict on how best to navigate a new city, house and school.", 
						DIR + "/poster/" + "inside_out_poster.jpg", 
						"https://www.youtube.com/watch?v=_MC3XuMvsDI")

movies = [titanic, zootopia, moonlight, the_jungle_book, la_la_land, inside_out]
